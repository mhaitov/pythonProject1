...
# user_input = input("Please enter your solary: ")
# print(user_input)
...
# a,b,c = input('Please enter sides A, B and C. Use space separet: ').split()  # User input of 3 sides
#   # Half perimeter
